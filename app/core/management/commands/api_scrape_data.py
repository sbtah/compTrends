...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        number_of_products_local_data_start = ProductLocalData.objects.all().count()
        ...
        self.stdout.write(
            self.style.WARNING(
                ...
                Current number of ProductLocalDatas: {number_of_products_local_data_start}
                """
            )
        )
        ...
        number_of_products_local_data_finish = ProductLocalData.objects.all().count()
        ...
        self.stdout.write(
            self.style.SUCCESS(
                ...
                Current number of ProductLocalDatas: {number_of_products_local_data_finish}
                """
            )
        )
